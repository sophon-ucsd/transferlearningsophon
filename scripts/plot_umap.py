#!/usr/bin/env python3
"""Paired UMAP (pretrained Sophon vs full fine-tune).

Axis-locked panels, silhouette annotations. Saves UMAP coords to a cache .npz
so subsequent layout edits don't repeat the slow fit.

Outputs:
    <--output>.{pdf,png}   (default: /data/results/poster/umap_paired)
"""
...
def main():
    ...
    p.add_argument("--output",
                   default="/data/results/poster/umap_paired")
